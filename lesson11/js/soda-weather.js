const apiURL = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&appid=8647c7488ee65eeef25bce2fbb5f6304"
...
fetch(apiURL)
  ...
  .then((jsObject) => {
    ...
    document.getElementById("mph").innerHTML = Math.round(windspeed);


    // Code for windchill
    const temp = document.getElementById("temp").textContent;
    const mph = document.getElementById("mph").textContent;
